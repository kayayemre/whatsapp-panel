...
export default function DashboardPage() {
 ...
 const updateStatus = async (id, newStatus) => {
  ...
  const getRowColor = (status, index) => {
    if (status === 'ARANDI') {
      return index % 2 === 0 ? 'bg-gradient-to-r from-green-50 to-green-100 hover:from-green-100 hover:to-green-150' : 'bg-gradient-to-r from-green-100 to-green-150 hover:from-green-150 hover:to-green-200'
    } else {
      return index % 2 === 0 ? 'bg-gradient-to-r from-pink-50 to-pink-100 hover:from-pink-100 hover:to-pink-150' : 'bg-gradient-to-r from-pink-100 to-pink-150 hover:from-pink-150 hover:to-pink-200'
    }
  }
